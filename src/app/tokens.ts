export const TOKENS = {
  ...
  UploadPromotionalVideoController: Symbol.for("UploadPromotionalVideoController"),
  GetPromotionalVideosController: Symbol.for("GetPromotionalVideosController"),
  GetPromotionalVideoByIdController: Symbol.for("GetPromotionalVideoByIdController"),
  UpdatePromotionalVideoController: Symbol.for("UpdatePromotionalVideoController"),
  DeletePromotionalVideoController: Symbol.for("DeletePromotionalVideoController"),
  VideoServiceClient: Symbol.for("VideoServiceClient"),

	GetAdminPlansUseCase: Symbol.for("GetPlansUseCase"),
  ...
  GetAdminPlansController: Symbol.for("GetPlansController"),
  ...
  PaymentGateway: Symbol.for("PaymentGateway"),
	...
	AdminGoogleSignInController: Symbol.for("AdminGoogleSigninController"),
		AuthenticateAdminUserCase: Symbol.for("AuthenticateAdminUserCase"),
